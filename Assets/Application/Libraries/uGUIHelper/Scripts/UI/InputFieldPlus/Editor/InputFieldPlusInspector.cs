...
namespace UnityEditor.UI
{
	...
	[CustomEditor( typeof( InputFieldPlus ), true )]
	public class InputFieldCustomInspector : SelectableEditor
	{
		...
		SerializedProperty m_ImeColor ;	// 追加機能
		...
		protected override void OnEnable()
		{
			...
			m_ImeColor = serializedObject.FindProperty("m_ImeColor");	// 追加機能
		...
		public override void OnInspectorGUI()
		{
			...
			using( new EditorGUI.DisabledScope( m_TextComponent == null || m_TextComponent.objectReferenceValue == null ) )
			{
				...
				if (!m_ContentType.hasMultipleDifferentValues)
				{
					...
					if (m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentType.Standard ||
						m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentType.Autocorrected ||
						m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentType.Custom)
						EditorGUILayout.PropertyField(m_LineType);

					if (m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentType.Custom)
					{
				...
				EditorGUILayout.PropertyField(m_ImeColor ) ;	// 追加機能
